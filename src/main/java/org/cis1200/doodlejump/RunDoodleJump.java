...
public class RunDoodleJump implements Runnable {
    ...
    public static final String TEXT = """
            ...
            and not falling. Don't worry about jumping though, because your character auto jumps!
            ...
            help you, but some platforms will move or disappear. Unlike Doodle Jump, you aren't
